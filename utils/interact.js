...
const contract = require('../artifacts/contracts/TrophyRoomClub.sol/TrophyRoomClub.json')
...
export const mintNFT = async (mintAmount) => {
  ...
  const transactionParameters = {
    ...
    gasLimit: '0',
    data: nftContract.methods.presaleMint(mintAmount).encodeABI() // make call to NFT smart contract
  }
